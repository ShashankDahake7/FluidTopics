    ...
    <footer className="portal-footer">
      <div className="portal-footer-inner">
        <div className="portal-footer-row">
          <Link href="/portal" className="portal-footer-logo" aria-label="Darwinbox">
            <img src="/ft-header-logo.png" alt="Darwinbox" />
          </Link>
          ...
          <div className="portal-footer-socials">
            <Social label="Facebook" href="https://www.facebook.com/Darwinbox">
            ...
            <Social label="LinkedIn" href="https://www.linkedin.com/company/darwinbox">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <Social label="Twitter" href="https://x.com/Darwinbox">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <Social label="Instagram" href="https://www.instagram.com/Darwinbox">
